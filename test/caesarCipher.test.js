...
describe('Unit tests for caesarCipher.js', () => {
    describe('decrypt() - check whether CDEF is correctly decrypted as ABCD with key=2', () => {
    ...
    describe('decrypt() - check whether ABCD is correctly decrypted as YZAB with key=2', () => {
